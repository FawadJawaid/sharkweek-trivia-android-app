...
public class PrivacypolicyActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		crossmenuBtn = (ImageButton) findViewById(R.id.activity_main_content_button_menu2);
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			try {
				...
				if (diff > SWIPE_MIN_DISTANCE
					...
					PrivacypolicyActivity.this.onLeftSwipe();

					// Right swipe
				} else if (-diff > SWIPE_MIN_DISTANCE
						&& Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
					PrivacypolicyActivity.this.onRightSwipe();
				}
			} catch (Exception e) {
				Log.e("PrivacypolicyActivity", "Error on gestures");
			}
			return false;
		}
	}
	...
	void settingFonts() {
		heading = (TextView) findViewById(R.id.privpolicyHeader);
		content = (TextView) findViewById(R.id.privpolicyContent);
